...
# As you read in the README file, this is a short tutorial
# that walks through the essential foundations of R programming. 
...
x <- 10
# Create a variable named 'y' and assign it the value 5
y <- 5

# Now you can use these variables in calculations
...
# Vectors are a fundamental data structure in R that can hold multiple values of the same type. they are a series of items stored in a single variable.
...
# Logical data type represents boolean values: TRUE and FALSE. You can create logical variables and perform logical operations on them

# This type of data allows some comparison operations between values
...
# We use some of them before, such as c(), lenghth(), mean(), print(), paste(), matrix(), and seq()
...
# R base provides various statistical functions to perform statistical operations on data
...
# Data frames are a fundamental data structure in R for storing tabular data. They are similar to matrices but can hold different types of data (as we saw in 1.5) in each column.
...
# 4.1 Manipulating data and data frames ----------------------------------------------
...
# However, you can create basic graphs using base R functions. Some common types of graphs include:
